...
import './Navbar.css'
import logo from '../../Assets/TheVillageLogoWhite.png'
  ...
  return (
    <nav>
        <div className='navbarSection1'>
            ...
            <div className='searchbar'><input typ='text' placeholder='Search for Products' className='search' />
        ...
        <div className='navbarSection2'>
            <Dropdown>
                <Dropdown.Toggle variant="" id="dropdown-basic"> Products </Dropdown.Toggle>

                <Dropdown.Menu>
                    <Dropdown.Item href="#/action-1"> Vegetables </Dropdown.Item>
                    <Dropdown.Item href="#/action-1"> Fruits </Dropdown.Item>
                    <Dropdown.Item href="#/action-1"> Masala </Dropdown.Item>
                </Dropdown.Menu>
            </Dropdown>
